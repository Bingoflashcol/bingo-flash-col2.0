...
function exportParticipantsPDF(){
  ...
  document.addEventListener('DOMContentLoaded', ()=>{
    wireForm(); renderList(); renderTop();
    const ev = document.querySelector('#eventId'); if(ev) ev.addEventListener('input', ()=>{ renderList(); renderTop(); });
    ...
    document.getElementById('top-refresh')?.addEventListener('click', renderTop);
